...
#define MBED_CONF_APP_CAN1_RD                       p9   // set by application[LPC1768]
#define MBED_CONF_APP_CAN1_TD                       p10  // set by application[LPC1768]
...
#define MBED_CONF_APP_CAN2_RD                       p30  // set by application[LPC1768]
#define MBED_CONF_LWIP_IPV6_ENABLED                 0    // set by library:lwip
#define MBED_CONF_APP_CAN2_TD                       p29  // set by application[LPC1768]
// Macros
